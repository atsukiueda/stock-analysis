...
| Field | Value |
|---|---|
| Document / Revision | DOC-CON-000 / DOC-CON-000@0.13.0-draft |
| Provenance | PROV-DOC-CONST-000-0013 |
| Artifact type / state | AT-CONSTITUTION / Draft |
| IAP | IAP-DOC-CON-000-0.13.0-DRAFT (Appendix E) |
| Draft source | `Documentation/Drafts/000_ProjectDocumentationConstitution.v0.13.0-draft.md` |
