# Micron Technology — MU-SFI-013 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-013` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-013` issued — EVR Review Accepted / PIT not issued |

> **利用境界：** CNBUはData Center、PC、graphics等のmixed scopeでありAI / HBM revenueへ配賦しない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。
...
| Applicable Period | Source Factに明示された期間 / 時点: FY2024 / FY2023 / FY2022 |
| URL | [Official source](https://investors.micron.com/sec-filings/sec-filing/10-k/0000723125-24-000027) |
| Source position | FY2024 10-K p.8, CNBU |
...
CNBU revenueはFY2024 USD9.51bn、FY2023 USD5.71bn、FY2022 USD13.69bn。

| Field | Value |
| --- | --- |
| Fact type / classification | Mixed-market revenue Actual — 上流Inspectionの分類を変更しない |
...
| Related candidate boundary | Pre-2025 reporting structure |
| AvailableAt | `TBD — no use` |
| Catalog Eligibility | `No` |

## 3. 制約

- CNBUはData Center、PC、graphics等のmixed scopeでありAI / HBM revenueへ配賦しない。
