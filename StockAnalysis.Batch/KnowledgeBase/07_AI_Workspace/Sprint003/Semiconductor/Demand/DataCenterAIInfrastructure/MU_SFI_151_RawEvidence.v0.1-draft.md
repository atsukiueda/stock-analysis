# Micron Technology — MU-SFI-151 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-151` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-133` issued — EVR Review Accepted / PIT not issued |

> **利用境界：** Growth率、absolute revenue、AI-only contribution、unit、customer又はshareを補完しない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。

## 1. 一次資料

| 項目 | 内容 |
| --- | --- |
| 資料名 | Micron Technology, Inc., *Fiscal Q4 2025 Earnings Call Prepared Remarks* |
| Publication Event | 2025-09-23 16:30 EDT |
| Applicable Period | Publication Event 2025-09-23 16:30 EDT時点のcurrent / Actual assertion |
| URL | [Official source](https://investors.micron.com/static-files/5ea95475-639b-4cfc-91fd-b9b4a2bb5e63) |
| Source position | FY2025 Q4 prepared remarks, LPDDR5 paragraph |
...
Server向けLPDDR5 revenueは当該quarterにrecord revenueへ達したと説明される。

| Field | Value |
| --- | --- |
| Fact type / classification | Actual-period revenue-record assertion — 上流Inspectionの分類を変更しない |
...
| Related candidate boundary | Sequential growth `129` separate |
| AvailableAt | `TBD — no use` |
| Catalog Eligibility | `No` |

## 3. 制約

- Growth率、absolute revenue、AI-only contribution、unit、customer又はshareを補完しない。
