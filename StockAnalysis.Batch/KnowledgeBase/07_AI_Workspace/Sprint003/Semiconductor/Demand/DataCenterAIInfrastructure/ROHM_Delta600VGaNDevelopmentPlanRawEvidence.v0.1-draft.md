# ROHM — Delta 600V GaN Development Plan Raw Evidence
...
| Issuer | ROHM Co., Ltd. |
| Inspection Source | `ROHMSourceFactInspection.v0.1-draft.md` — `ROHM-SFI-053` |
| Cross-sprint Recheck | `ROHMCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical candidate |
| Evidence ID | `S3-EVR-083` |
| Evidence Registration Status | Registered — `Sprint003DataCenterAIInfrastructureEvidenceRegister.v0.1-draft.md` / `S3-EVR-083`; EVR Review Accepted |
| PIT Mapping Status | Registered — `Sprint003DataCenterAIInfrastructurePITInventory.v0.1-draft.md` / `S3-PIT-083`; PIT Review Accepted |

> **利用境界：** Planであり、development completion、mass-production commencement、Data Center adoption、shipment又はrevenueを示さない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。
...
ROHMとDeltaはpower-supply system向け600V GaN power devicesを共同development / mass productionする方針を示す。

| Field | Value |
| --- | --- |
| Fact type | Named-party development / mass-production Plan |
| Actual / Forecast | Named-party development / mass-production Plan — 上流Inspectionの分類を変更しない |
| Unit | Voltage / development and mass-production Plan |
...
- Planであり、development completion、mass-production commencement、Data Center adoption、shipment又はrevenueを示さない。
