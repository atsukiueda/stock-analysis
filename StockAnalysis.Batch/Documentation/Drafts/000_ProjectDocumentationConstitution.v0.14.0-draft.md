...
| Field | Value |
|---|---|
| Document / Revision | DOC-CON-000 / DOC-CON-000@0.14.0-draft |
| Provenance | PROV-DOC-CONST-000-0014 |
| Artifact type / state | AT-CONSTITUTION / Draft |
| IAP | IAP-DOC-CON-000-0.14.0-DRAFT (Appendix E) |
| Draft source | `Documentation/Drafts/000_ProjectDocumentationConstitution.v0.14.0-draft.md` |
