...
> **APPROVED AND RELEASED.** This is the project entry point and a navigational document only; it introduces no new policy, decision, or system design.
...
|---|---|
| Draft | `README@0.2.0-draft` — source retained in `Documentation/Drafts/`; not canonical |
| Released | [Project Constitution](000_ProjectDocumentationConstitution.md) and this README |
...
The approval, release, and identifier evidence for the Project Constitution and this README are retained in `Documentation/Records/`.
