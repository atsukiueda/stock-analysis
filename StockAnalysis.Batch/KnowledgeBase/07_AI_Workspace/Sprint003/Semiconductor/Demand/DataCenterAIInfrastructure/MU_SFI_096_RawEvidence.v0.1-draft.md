# Micron Technology — MU-SFI-096 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-096` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-084` issued — EVR Review Accepted / PIT not issued |

> **利用境界：** Quantity、price、duration、order、shipment、revenue又はexclusive relationを補完しない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。

## 1. 一次資料

| 項目 | 内容 |
| --- | --- |
| 資料名 | Micron Technology, Inc., *Micron and Anthropic Announce Strategic Agreement to Scale Next-Generation AI Infrastructure* |
| Publication Event | 2026-06-22 09:00 EDT |
| Applicable Period | Publication Event 2026-06-22 09:00 EDT時点のcurrent / Actual assertion |
| URL | [Official source](https://investors.micron.com/node/50626) |
| Source position | 2026-06-22 release, agreement section |
...
MicronとAnthropicはMicron Data Center portfolioにわたるmemory / storage supply agreementを発表した。

| Field | Value |
| --- | --- |
| Fact type / classification | Named-party supply-agreement relationship — 上流Inspectionの分類を変更しない |
...
| Related candidate boundary | Technical collaboration `095` separate |
| AvailableAt | `TBD — no use` |
| Catalog Eligibility | `No` |

## 3. 制約

- Quantity、price、duration、order、shipment、revenue又はexclusive relationを補完しない。
