...
The proposed Policy will govern new project-level model-governance artifacts and governed model or decision-system work within its stated scope. It will apply Knowledge Base First, evidence, traceability, explainability, independent review, and long-term maintainability to model and decision-system direction without prescribing model algorithms, features, thresholds, investment conclusions, or implementation methods.

Existing Knowledge Base, research, documentation, development, data, and database authorities remain unchanged unless an approved migration explicitly changes their relationship. The Project Director remains accountable until a model-domain steward is appointed under the Constitution.
...
| Authority, roles, and decisions | Route Project Director, ML, Model Governance, Investment, and review roles | Project Constitution §§5–7 |
| Governed upstream dependency | Apply Knowledge Base First to Database → ML → Decision Engine → Advisor | Project Constitution §4 |
...
| Explainability, traceability, and provenance | Establish direction for understandable model and decision behavior | Project Constitution §2 |
| Validation, risk, and monitoring direction | Establish durable expectations; delegate methods and thresholds | Project Constitution §§2, 7 |
