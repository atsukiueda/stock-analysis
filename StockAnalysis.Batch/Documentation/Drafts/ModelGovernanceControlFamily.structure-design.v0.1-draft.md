...
## 2. Proposed artifacts and responsibilities
...
| 2 | Model & Decision-System Validation Standard | Standard | Define validation-control framework for models and decision systems; distinguish investment validation | Lifecycle Standard; released Model Governance Policy |
| 3 | Explainability & Traceability Standard | Standard | Define required explanation and traceability relationships across upstream knowledge, model, decision, and advisor artifacts | Lifecycle and Validation Standards |
