# Micron Technology — MU-SFI-031 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-031` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-028` issued — EVR Review Accepted / PIT not issued |

> **利用境界：** Shipment、AI専用製品、quantity、customer、revenue又はshareへ拡張しない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。
...
FY2025に6550 ION SSDをqualifiedした。

| Field | Value |
| --- | --- |
| Fact type / classification | Qualification Actual — 上流Inspectionの分類を変更しない |
| Upstream disposition | Proceed |
| Cross-sprint reference | No identical Source identity / event / position / Fact in Accepted recheck |
| Related candidate boundary | Shipping is separate `057` |
| AvailableAt | `TBD — no use` |
| Catalog Eligibility | `No` |

## 3. 制約

- Shipment、AI専用製品、quantity、customer、revenue又はshareへ拡張しない。
