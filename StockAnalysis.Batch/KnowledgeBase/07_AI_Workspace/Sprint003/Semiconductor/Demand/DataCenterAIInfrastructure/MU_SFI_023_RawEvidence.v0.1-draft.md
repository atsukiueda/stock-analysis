# Micron Technology — MU-SFI-023 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-023` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-022` issued — EVR Review Accepted / PIT not issued |

> **利用境界：** HBM / AI-only revenueへ配賦せず、旧CNBUと定義確認なしに連結しない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。
...
| Applicable Period | Source Factに明示された期間 / 時点: FY2025 / FY2024 / FY2023 |
| URL | [Official source](https://investors.micron.com/sec-filings/sec-filing/10-k/0000723125-25-000028) |
| Source position | FY2025 10-K pp.9–10, CMBU |
...
CMBU revenueはFY2025 USD13.52bn、FY2024 USD3.79bn、FY2023 USD1.87bnとしてretrospectively adjusted表示される。
...
| Related candidate boundary | `013` is old reporting structure |
| AvailableAt | `TBD — no use` |
| Catalog Eligibility | `No` |

## 3. 制約

- HBM / AI-only revenueへ配賦せず、旧CNBUと定義確認なしに連結しない。
