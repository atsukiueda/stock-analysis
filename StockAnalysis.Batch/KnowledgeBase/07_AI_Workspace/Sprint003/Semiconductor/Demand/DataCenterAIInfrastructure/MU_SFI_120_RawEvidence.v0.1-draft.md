# Micron Technology — MU-SFI-120 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-120` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-107` issued — EVR Review Accepted / PIT not issued |
...
Anthropic speakerはMicronとの関係が必要なsupply確保につながると述べた。

| Field | Value |
| --- | --- |
| Fact type / classification | External-party supply assertion — 上流Inspectionの分類を変更しない |
...
| Related candidate boundary | Centrality assertion `097`; agreement `096` separate |
