# Micron Technology — MU-SFI-101 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-101` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-089` issued — EVR Review Accepted / PIT not issued |

> **利用境界：** Vendor identity、9650 identity、qualification、availability、deployment、shipment又はuniversal performanceへ自動変換しない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。

## 1. 一次資料

| 項目 | 内容 |
| --- | --- |
| 資料名 | Micron Technology, Inc., *Micron Innovates From the Data Center to the Edge With NVIDIA* |
| Publication Event | 2025-03-18 16:24 EDT |
| Applicable Period | Publication Event 2025-03-18 16:24 EDT時点で開示された比較 / test basis（Fact本文の条件に限定） |
| URL | [Official source](https://investors.micron.com/news-releases/news-release-details/micron-innovates-data-center-edge-nvidia) |
| Source position | 2025-03-18 release, storage paragraph |
...
Micron PCIe Gen6 SSDはleading PCIe switch / retimer vendorsとのinteroperability testで27GB/s超を示したと説明される。

| Field | Value |
| --- | --- |
| Fact type / classification | PCIe Gen6 interoperability-test assertion — 上流Inspectionの分類を変更しない |
...
| Related candidate boundary | Historical test context |
