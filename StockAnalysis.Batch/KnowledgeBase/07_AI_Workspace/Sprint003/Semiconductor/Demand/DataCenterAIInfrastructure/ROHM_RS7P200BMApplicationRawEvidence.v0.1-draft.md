# ROHM — RS7P200BM Application Raw Evidence
...
| Issuer | ROHM Co., Ltd. |
| Inspection Source | `ROHMSourceFactInspection.v0.1-draft.md` — `ROHM-SFI-033` |
| Cross-sprint Recheck | `ROHMCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical candidate |
| Evidence ID | `S3-EVR-064` |
| Evidence Registration Status | Registered — `Sprint003DataCenterAIInfrastructureEvidenceRegister.v0.1-draft.md` / `S3-EVR-064`; EVR Review Accepted |
| PIT Mapping Status | Registered — `Sprint003DataCenterAIInfrastructurePITInventory.v0.1-draft.md` / `S3-PIT-064`; PIT Review Accepted |

> **利用境界：** Product suitabilityであり、AI-server adoption、shipment、revenue又はActual demandを示さない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。
...
ROHMはRS7P200BMを48V AI-server hot-swap circuit及びindustrial power supply向けproductとして位置付ける。
...
- Product suitabilityであり、AI-server adoption、shipment、revenue又はActual demandを示さない。
