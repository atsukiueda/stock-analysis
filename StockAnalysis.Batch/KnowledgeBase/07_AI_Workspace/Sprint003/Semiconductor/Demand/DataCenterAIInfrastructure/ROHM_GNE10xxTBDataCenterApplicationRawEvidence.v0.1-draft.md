# ROHM — GNE10xxTB Data Center Application Raw Evidence
...
| Issuer | ROHM Co., Ltd. |
| Inspection Source | `ROHMSourceFactInspection.v0.1-draft.md` — `ROHM-SFI-062` |
| Cross-sprint Recheck | `ROHMCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical candidate |
| Evidence ID | `S3-EVR-092` |
| Evidence Registration Status | Registered — `Sprint003DataCenterAIInfrastructureEvidenceRegister.v0.1-draft.md` / `S3-EVR-092`; EVR Review Accepted |
| PIT Mapping Status | Registered — `Sprint003DataCenterAIInfrastructurePITInventory.v0.1-draft.md` / `S3-PIT-092`; PIT Review Accepted |

> **利用境界：** Product suitabilityであり、Data Center専用production、adoption、shipment、revenue又はActual demandを示さない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。
...
ROHMはGNE10xxTB seriesをData Center / base-station向け48V input buck-converter circuit等に位置付ける。
...
- Product suitabilityであり、Data Center専用production、adoption、shipment、revenue又はActual demandを示さない。
