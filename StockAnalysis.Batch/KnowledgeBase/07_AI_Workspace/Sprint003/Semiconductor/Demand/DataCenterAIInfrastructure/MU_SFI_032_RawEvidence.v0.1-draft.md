# Micron Technology — MU-SFI-032 Raw Evidence
...
| Inspection Source | `MicronSourceFactInspection.v0.1-draft.md` — `MU-SFI-032` |
| Cross-sprint Recheck | `MicronCrossSprintCandidateRecheck.v0.1-draft.md` — Accepted; no identical Fact |
| Evidence / PIT ID | `S3-P2-EVR-029` issued — EVR Review Accepted / PIT not issued |

> **利用境界：** SOCAMM shipment、quantity、全customer adoption、order、revenue、share又はindustry demandを補完しない。 `AvailableAt = TBD — no use`、Catalog Eligibility `No`。
...
| Source position | 2025-03-18 release, opening |
...
MicronはHBM3EをData CenterのAI server向けにshippingしていると述べる。

| Field | Value |
| --- | --- |
| Fact type / classification | Current HBM3E shipment assertion — 上流Inspectionの分類を変更しない |
| Upstream disposition | Proceed |
| Cross-sprint reference | No identical Source identity / event / position / Fact in Accepted recheck |
| Related candidate boundary | SOCAMM shipment is separate `058` |
